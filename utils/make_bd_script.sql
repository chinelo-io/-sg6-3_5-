...
CREATE TABLE main.parameters_system ( 
	ID uuid NOT NULL PRIMARY KEY, 
	id_aux VARCHAR NOT NULL, 
	descricion VARCHAR NOT NULL, 
...
VALUES
	( '3b43cf08-75d1-45f5-a231-98b8bffef84d', 'Comercial María Félix', 'RFCMARIAFELIX', 't', now( ), now( ) );
INSERT INTO main.factory ( ID, nombre, rfc, estatus, created_at, updated_at )
VALUES
	( '85d499b8-ea6b-4a96-ab82-b2097facaad2', 'chinelo.io', 'RFCHINELOIO', 't', now( ), now( ) );
INSERT INTO main.ROLE ( ID, nombre, descripcion, estatus, created_at, updated_at )
VALUES
	( '487cca01-0f94-42bf-8bd9-39e70b6b1003', 'ROLE_ADMIN', 'Role para el administrador del sistema', 't', now( ), now( ) );
INSERT INTO main.ROLE ( ID, nombre, descripcion, estatus, created_at, updated_at )
VALUES
	( '84c4fc7d-d9a7-4d94-a9f3-2608c96fb62e', 'ROLE_USER', 'Role para el usuario comun que utiliza el sismtema', 't', now( ), now( ) );
INSERT INTO main.USER ( ID, nombre, email, PASSWORD, estatus, factory_id, created_at, updated_at )
VALUES
	( 'f6023bec-77d1-42b0-9f39-e0d7285d2a91', 'Papeleria', 'comercialmariafelix@hotmail.com', 'hlgnJTYg0RT8lq6RRSKPYQ==', 't', '3b43cf08-75d1-45f5-a231-98b8bffef84d', now( ), now( ) );
INSERT INTO main.USER ( ID, nombre, email, PASSWORD, estatus, factory_id, created_at, updated_at )
VALUES
	( '9683d0b2-e73e-4611-902d-ae083377e1cb', 'Marco Antonio Barrios Molina', 'marcoabm@chinelo.io', 'hlgnJTYg0RT8lq6RRSKPYQ==', 't', '85d499b8-ea6b-4a96-ab82-b2097facaad2', now( ), now( ) );
INSERT INTO main.user_has_role ( ID, estatus, user_id, role_id, created_at, updated_at )
VALUES
	( 'cdb891a9-07e3-47fc-b1ae-c7e1d93b6770', 't', 'f6023bec-77d1-42b0-9f39-e0d7285d2a91', '84c4fc7d-d9a7-4d94-a9f3-2608c96fb62e', now( ), now( ) );
INSERT INTO main.user_has_role ( ID, estatus, user_id, role_id, created_at, updated_at )
VALUES
	( '920bc6c5-0b37-4b0a-977a-ea3cde277ea8', 't', '9683d0b2-e73e-4611-902d-ae083377e1cb', '487cca01-0f94-42bf-8bd9-39e70b6b1003', now( ), now( ) );
INSERT INTO main.customer ( ID, nombre, estatus, factory_id, created_at, updated_at )
VALUES
	( '5f8e7a32-11b8-49c5-a1f2-ac9e556103f0', 'Publico en General', 't', '3b43cf08-75d1-45f5-a231-98b8bffef84d', now( ), now( ) );
INSERT INTO main.tax ( ID, nombre, descripcion, valor, estatus, created_at, updated_at )
VALUES
	( 'ebd9d5f0-80da-42dd-b249-9efa5f5c3376', 'IVA', 'Impuesto de IVA', 16, 't', now( ), now( ) );
SELECT
	u.ID AS user_id,
